...
public class Config {
    ...
    public static final String CHECK_FOR_PROTECTION_PLUGINS = "check-for-protection-plugins";
    ...
    public static final String CHECK_OTHER_PLUGINS = "check-for-other-plugins";
    public static final String DEBUG = "debug";

    public static void init() {
        //Main main = Main.getInstance();
        FileConfiguration conf = Main.getInstance().getConfig();
        conf.addDefault(CHECK_OTHER_PLUGINS, true);
        conf.addDefault(CHECK_FOR_UPDATES, "true");
        conf.addDefault(CHECK_FOR_UPDATES_INTERVAL, 4);
        conf.addDefault(CHECK_FOR_PROTECTION_PLUGINS, true);
